...
```{r}
# Computing the predictions with the model on the test set:
pred_glm_comp_step<- predict(glm_compl_step, test, type = "response")
# Converting the prediction in {0,1} according to the chosen threshold:
pred_glm_compl_step_04<- ifelse(pred_glm_comp_step > threshold4, 1, 0)
pred_glm_compl_step_05<- ifelse(pred_glm_comp_step > threshold5, 1, 0)
pred_glm_compl_step_06<- ifelse(pred_glm_comp_step > threshold6, 1, 0)
pred_glm_compl_step_07<- ifelse(pred_glm_comp_step > threshold7, 1, 0)
